...
class Wall:
    ...
    def __init__(self):
        ...
        try:
            with open(self.USERS, 'r', encoding='utf-8'): # если уже создан
                pass
        except FileNotFoundError:
            with open(self.USERS, 'w', encoding='utf-8') as f: # если не создан создаем пустой
                json.dump({}, f)
    ...
    # dump - сериализация (объект в строку-указатель); load - десереализация (строка-указатель в объект)
